...
WebUI.click(findTestObject('Page_ProSpark  test/txtSearchUser - Add'))

WebUI.setText(findTestObject('Page_ProSpark  test/txtSearchUser - Add'), 'ihsan ')

WebUI.click(findTestObject('Page_ProSpark  test/cbxHeader - Add'))

WebUI.click(findTestObject('Page_ProSpark  test/btnAddSelctedUser'))
